...
(async () => {
    ...
    await page.click('#btn-open-form');
    ...
    try {
        ...
        await page.fill('#exp-cantidad', '3');
        await page.fill('#exp-costo-unitario', '2000');
        await page.fill('#exp-comentarios-compra', 'Prueba E2E Modal V2');
        
        await page.click('#btn-add-expense');
        console.log("=> Compra de insumo agregada a la lista.");
    } catch(e) {
        console.log("No se pudieron cargar insumos.", e);
    }
    ...
    // Bypass visibility checks using evaluate click
    await page.evaluate(() => {
    ...
    await page.fill('#exp-descripcion', 'Prueba Modal E2E');
    await page.fill('#exp-valor-gasto', '10000');
    await page.selectOption('#exp-pago-gasto', 'Efectivo');
    await page.fill('#exp-comentarios-gasto', 'Prueba automática modal');
